...
<body bgcolor="tan">
<center>
<b><font color = "brown" size="6">Faculty Voting System</font></b></center><br><br>
<body>
<div id="page">
<div id="header">
  <h1>CURRENT POLLS</h1>
...
?>
<tr>
    <h3>Click a circle under a respective candidate to cast your vote. You can't vote more than once in a respective position. This process can not be undone so think wisely before casting your vote.</h3>
    <td>&nbsp;</td>
</tr>
</form>
</table>
...
<div id="footer"> 
  <div class="bottom_addr">&copy; designed by grp 7</div>
</div>
</div>
</body>
</html>